...
class McpManager:
    ...
    _KNOWN_SERVERS: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "capabilities": ["tool.postgres.query", "tool.postgres.schema"],
            "transport": "stdio",
        },
        {
            "name": "SQLite",
            ...
            "capabilities": ["tool.sqlite.query", "tool.sqlite.tables"],
            "transport": "stdio",
        },
        {
            "name": "Supabase",
            ...
            "capabilities": ["tool.supabase.query", "tool.supabase.storage"],
            "transport": "stdio",
        },
        {
            "name": "Docker",
            ...
            "capabilities": ["tool.docker.containers", "tool.docker.images"],
            "transport": "stdio",
        },
        {
            "name": "Terminal",
            ...
            "capabilities": ["tool.terminal.execute"],
            "transport": "stdio",
        },
        {
